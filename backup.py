...
filetest = open('DataTest_Tugas3_AI.csv', 'r')
readertest = csv.reader(filetest, quoting=csv.QUOTE_NONNUMERIC)

filetrain = open('DataTrain_Tugas3_AI.csv', 'r')
readertrain = csv.reader(filetrain, quoting=csv.QUOTE_NONNUMERIC)
